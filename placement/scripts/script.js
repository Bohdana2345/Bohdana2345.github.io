...
window.addEventListener('DOMContentLoaded', () => {
    ...
    function homeSectionScrollEffect() {
        ...
        if (scrollY > 0) {
            homeSection.style.background = `linear-gradient(180deg, rgba(0, 0, 0, ${opacity * 1.2}) 100%, rgba(0, 0, 0, 1) 100%), url('https://bohdana2345.github.io/placement/assets/img/home-bg.webp')`;
        } else {
            if (screenWidth < 1000) {
                homeSection.style.background = `linear-gradient(180deg, rgba(255, 255, 255, 0) 0%, #FFFFFF 200%), url('https://bohdana2345.github.io/placement/assets/img/home-bg.webp')`;
            } else {
                homeSection.style.background = `url('https://bohdana2345.github.io/placement/assets/img/home-bg.webp')`;
            }
        }
